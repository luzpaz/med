...
IF(WINDOWS)
  ...
  SET(PLATFORM_DEFINITIONS "${PLATFORM_DEFINITIONS} -D_SECURE_SCL=0") # To avoid runtime error during checking iterators 
  SET(PLATFORM_DEFINITIONS "${PLATFORM_DEFINITIONS} -D_SECURE_SCL_THROWS=0") # To avoid runtime error during checking iterators 
  SET(PLATFORM_DEFINITIONS "${PLATFORM_DEFINITIONS} -D_HAS_ITERATOR_DEBUGGING=0")  # To avoid runtime error during checking iterators 
