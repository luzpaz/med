...
IF(MED_ENABLE_PARMETIS)
  IF(PARMETIS_ROOT_USER)
    SET(PARMETIS_INCLUDE_PATHS ${PARMETIS_ROOT_USER}/include)
  ELSE(PARMETIS_ROOT_USER)
  ...
  IF(PARMETIS_INCLUDE_DIR)
    IF(PARMETIS_ROOT_USER)
      SET(PARMETIS_INCLUDES -I${PARMETIS_INCLUDE_DIR})
    ENDIF(PARMETIS_ROOT_USER)
    SET(PARMETIS_INCLUDES -D_PARMETISUSEDLL_ ${PARMETIS_INCLUDES})
...
IF(MED_ENABLE_PARMETIS)
  IF(PARMETIS_ROOT_USER)
    IF(WINDOWS)
      SET(PARMETIS_LIB_PATHS ${PARMETIS_ROOT_USER}/dll ${PARMETIS_ROOT_USER}/lib)
    ELSE(WINDOWS)
      SET(PARMETIS_LIB_PATHS ${PARMETIS_ROOT_USER}/lib)
    ENDIF(WINDOWS)
  ELSE(PARMETIS_ROOT_USER)
...
IF(MED_ENABLE_PARMETIS)
  SET(PARMETIS_CPPFLAGS ${PARMETIS_INCLUDES} -DMED_ENABLE_PARMETIS)
