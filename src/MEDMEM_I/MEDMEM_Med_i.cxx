...
void MED_i::init(SALOMEDS::Study_ptr myStudy,driverTypes /*driverType*/, const string & fileName)
{
  ...
  for (int i=0; i<fieldsNames.size(); i++) 
  {
    ...
    for (int j=0; j<myIteration.size(); j++) 
    {
  ...
  throw (SALOME::SALOME_Exception)
{
  ...
  if ( !name.empty() )
  {
    for ( int i = 0; !support && i < _medmem_fields.size(); ++i )
...
MED_i::~MED_i()
{
  ...
  for ( int i = 0; i < _medmem_fields.size(); ++i )
...
//purpose  : * CORBA: Accessor for meshes names
//=======================================================================
...
//purpose  : * CORBA: Accessor for fields names
//=======================================================================
...
//=======================================================================
//function : getFieldIteration
//purpose  : * CORBA: Accessor for the Corba equivalent DT_IT_ (see MEDMEM direcrtory)
...
//=======================================================================
//function : getFieldIterations
//purpose  : * CORBA: Accessor for the list of Corba equivalent DT_IT_ (see MEDMEM direcrtory)
