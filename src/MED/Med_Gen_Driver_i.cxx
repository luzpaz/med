...
namespace {
                                ...
                                bool                     isAscii)
  {
    ...
    BEGIN_OF("Med_Gen_Driver_i::Save");
                                       ...
                                       bool isMultiFile)
{
  ...
  BEGIN_OF("Med_Gen_Driver_i::Load");
                                                ...
                                                CORBA::Boolean isASCII)
{
  ...
  BEGIN_OF("Med_Gen_Driver_i::IORToLocalPersistentID");
  SCRUTE(IORString);
  ...
  throw(SALOME::SALOME_Exception)
{
  ...
  BEGIN_OF("Med_Gen_Driver_i::LocalPersistentIDToIOR");
