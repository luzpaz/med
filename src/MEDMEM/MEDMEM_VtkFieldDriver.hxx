...
/*--------------------- DRIVER PART -------------------------------*/
  ...
  template <class T>   VTK_FIELD_DRIVER<T>::VTK_FIELD_DRIVER(const string & fileName, FIELD<T> * ptrField) :
  ...
  template <class T>  VTK_FIELD_DRIVER<T>::VTK_FIELD_DRIVER(const VTK_FIELD_DRIVER & fieldDriver):
  ...
  template <class T>  void VTK_FIELD_DRIVER<T>::openConstAppend() const throw (MEDEXCEPTION)
  {
  ...
  template <class T>  void VTK_FIELD_DRIVER<T>::closeConst() const throw (MEDEXCEPTION)
  {
  ...
  template <class T>  void VTK_FIELD_DRIVER<T>::openConst() const throw (MEDEXCEPTION)
  {
