...
/*
  Med File V 2.3 attributes in the med_2_3 namespace
*/
...
//Inclure l'ensemble du fichier med_outils.h
...
MEDMEM_EXPORT /*static*/ med_err  _MEDdatasetNumEcrire_231(med_idt pere,char *nom, med_type_champ type,
...
MEDMEM_EXPORT /*static*/ med_err _MEDdatasetNumLire_231(med_idt pere,char *nom,med_type_champ type,
                                      med_mode_switch interlace, med_size nbdim, med_size fixdim,
                                      med_size psize,med_mode_profil pflmod,  med_size * pfltab,
                                      med_int ngauss, unsigned char *val);

MEDMEM_EXPORT /*static*/ med_err MEDchampLire_231(med_idt fid,char *maa, char *cha, unsigned char *val,med_mode_switch interlace,med_int numco,
                                char * locname, char *profil, med_mode_profil pflmod, 
                                med_entite_maillage type_ent, med_geometrie_element type_geo,
                                med_int numdt, med_int numo);

MEDMEM_EXPORT /*static*/ med_err getFieldsOn(med_idt fid, char * nomcha, med_type_champ typcha, med_int ncomp,
                           med_entite_maillage entite) throw (MEDMEM::MEDEXCEPTION) ;

MEDMEM_EXPORT /*static*/ void MAJ_champs_231_232(med_idt fid) throw (MEDMEM::MEDEXCEPTION) ;
}
...
/*!
  ...
  all the directory path. fileNameOut is .med V2.3.2 file produced by this
  command in the directory $HOME/TMP_Med2_3Files/
*/
