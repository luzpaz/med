...
//CCRT      _numberOfNodeOfEachConstituent=new (int*)[1] ;
...
//CCRT      _constituents = new (int**)[1] ;
      _constituents = new int**[1] ;
//CCRT      _constituents[0] = new (int*)[2] ;
...
//CCRT      _numberOfNodeOfEachConstituent=new (int*)[1] ;
      _numberOfNodeOfEachConstituent=new int*[1] ;
//CCRT      _numberOfNodeOfEachConstituent[0]=new (int)[3] ;
...
//CCRT      _constituents = new (int**)[1] ;
      _constituents = new int**[1] ;
//CCRT      _constituents[0] = new (int*)[3] ;
      _constituents[0] = new int*[3] ;
//CCRT      _constituents[0][0] = new int[1] ;
      _constituents[0][0] = new int[1] ;
      _constituents[0][0][0] = 1 ;
      _constituents[0][1] = new int[1] ;
      _constituents[0][1][0] = 2 ;
...
//CCRT      _numberOfNodeOfEachConstituent[0]=new (int)[3] ;
      ...
      _edge3[0]=3;
      _edge3[1]=1;
//CCRT      int ** tmpConstituents1 = new (int*)[3];
...
//CCRT      _numberOfNodeOfEachConstituent=new (int*)[1] ;
      _numberOfNodeOfEachConstituent=new int*[1] ;
//CCRT      _numberOfNodeOfEachConstituent[0]=new (int)[4] ;
      ...
      _edge4[0]=4;
      _edge4[1]=1;
//CCRT      int ** tmpConstituents1 = new (int*)[4];
...
//CCRT      _numberOfNodeOfEachConstituent=new (int*)[2] ;
...
//CCRT      _numberOfNodeOfEachConstituent[0]=new (int)[4] ;
      ...
      _numberOfNodeOfEachConstituent[0][2]=3 ;
      _numberOfNodeOfEachConstituent[0][3]=3 ;
//CCRT      _numberOfNodeOfEachConstituent[1]=new (int)[6] ;
...
//CCRT      int ** tmpConstituents2 = new (int*)[6];
...
//CCRT      _numberOfNodeOfEachConstituent=new (int*)[2] ;
      _numberOfNodeOfEachConstituent=new int*[2] ;
//CCRT      _numberOfNodeOfEachConstituent[0]=new (int)[6] ;
...
//CCRT      _numberOfNodeOfEachConstituent[1]=new (int)[12] ;
     ...
     int* _face6=new int[4];
      ...
      _face6[2]=5;
      _face6[3]=1;
//CCRT      int ** tmpConstituents1 = new (int*)[6];
...
//CCRT      int ** tmpConstituents2 = new (int*)[12];
...
//CCRT      _numberOfNodeOfEachConstituent=new (int*)[2] ;
      _numberOfNodeOfEachConstituent=new int*[2] ;
//CCRT      _numberOfNodeOfEachConstituent[0]=new (int)[5] ;
      ...
      _numberOfNodeOfEachConstituent[0][3]=4 ;
      _numberOfNodeOfEachConstituent[0][4]=4 ;
//CCRT      _numberOfNodeOfEachConstituent[1]=new (int)[9] ;
      ...
      _face5[2]=4;
      _face5[3]=1;
//CCRT      int ** tmpConstituents1 = new (int*)[5];
      ...
      tmpConstituents1[3]=_face4 ;
      tmpConstituents1[4]=_face5 ;
//CCRT      int ** tmpConstituents2 = new (int*)[9];
...
//CCRT      _constituents = new (int**)[2] ;
      ...
      tmpConstituentsType2[7] = MED_SEG3 ;
      tmpConstituentsType2[8] = MED_SEG3 ;
//CCRT      _constituentsType = new (medGeometryElement*)[2] ;
      _constituentsType = new medGeometryElement*[2] ;
      _constituentsType[0]=tmpConstituentsType1 ;
      _constituentsType[1]=tmpConstituentsType2 ;
      break ;
...
//CCRT      _numberOfNodeOfEachConstituent[1]=new (int)[8] ;
...
//CCRT      int ** tmpConstituents1 = new (int*)[5];
      ...
      tmpConstituents1[3]=_face4 ;
      tmpConstituents1[4]=_face5 ;
//CCRT      int ** tmpConstituents2 = new (int*)[8];
...
//CCRT  _numberOfNodeOfEachConstituent = new (int*)[_numberOfConstituentsDimension] ;
...
//CCRT  _constituents = new (int**)[_numberOfConstituentsDimension] ;
  _constituents = new int**[_numberOfConstituentsDimension] ;
//CCRT  _constituentsType = new (medGeometryElement*)[_numberOfConstituentsDimension] ;
  _constituentsType = new medGeometryElement*[_numberOfConstituentsDimension] ;
  for(int i=0; i<_numberOfConstituentsDimension; i++) {
    int numberOf = _numberOfConstituents[i] ;
//CCRT    int ** tmpArray = new (int*)[numberOf] ;
