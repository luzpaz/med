...
med_err OLD_MEDattrNumLire(med_idt pere,med_type_champ type,char *nom,unsigned char *val,hid_t hdf_file)
{
  med_idt attid;
  med_err ret;
  int type_hdf;
...
void conversion_chaine(char *ancienne_chaine,char *nouvelle_chaine,med_int n)
{
  int i;
  int j;
...
void MAJ_version(med_idt fid) throw (MEDEXCEPTION)
{
  med_err ret;
  med_idt gid;
...
void MAJ_noeuds_maillage(med_idt mid, med_int dimension) throw (MEDEXCEPTION)
{
  med_idt nid, gid, tid;
  med_float *coo;
  char *nom, *unit;
...
void MAJ_elements_maillage(med_idt mid, med_int dimension) throw (MEDEXCEPTION)
{
...
void MAJ_familles_maillage(med_idt mid) throw (MEDEXCEPTION)
{
  med_idt fid, gid;
  char *nouvelle_chaine;
  int n;
...
void MAJ_maillages(med_idt fid) throw (MEDEXCEPTION)
{
  med_idt gid;
  med_err ret;
  int n,i;
...
void MAJ_champs(med_idt fid) throw (MEDEXCEPTION)
{
...
void MAJ_profils(med_idt fid,med_int nprofil) throw (MEDEXCEPTION)
{
  med_err ret;
  med_int i;
  char nom[MED_TAILLE_NOM+1];
