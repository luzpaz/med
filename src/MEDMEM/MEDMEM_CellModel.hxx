...
private:
  ...
  CELLMODEL_Map(){
    _cell_models.insert(make_pair(MED_EN::MEDMEM_NONE     ,CELLMODEL(MED_EN::MEDMEM_NONE     )));
    _cell_models.insert(make_pair(MED_EN::MEDMEM_POINT1   ,CELLMODEL(MED_EN::MEDMEM_POINT1   )));
    _cell_models.insert(make_pair(MED_EN::MEDMEM_SEG2     ,CELLMODEL(MED_EN::MEDMEM_SEG2     )));
    _cell_models.insert(make_pair(MED_EN::MEDMEM_SEG3     ,CELLMODEL(MED_EN::MEDMEM_SEG3     )));
    _cell_models.insert(make_pair(MED_EN::MEDMEM_TRIA3    ,CELLMODEL(MED_EN::MEDMEM_TRIA3    )));
    _cell_models.insert(make_pair(MED_EN::MEDMEM_QUAD4    ,CELLMODEL(MED_EN::MEDMEM_QUAD4    )));
    _cell_models.insert(make_pair(MED_EN::MEDMEM_TRIA6    ,CELLMODEL(MED_EN::MEDMEM_TRIA6    )));
    _cell_models.insert(make_pair(MED_EN::MEDMEM_QUAD8    ,CELLMODEL(MED_EN::MEDMEM_QUAD8    )));
    _cell_models.insert(make_pair(MED_EN::MEDMEM_TETRA4   ,CELLMODEL(MED_EN::MEDMEM_TETRA4   )));
    _cell_models.insert(make_pair(MED_EN::MEDMEM_PYRA5    ,CELLMODEL(MED_EN::MEDMEM_PYRA5    )));
    _cell_models.insert(make_pair(MED_EN::MEDMEM_PENTA6   ,CELLMODEL(MED_EN::MEDMEM_PENTA6   )));
    _cell_models.insert(make_pair(MED_EN::MEDMEM_HEXA8    ,CELLMODEL(MED_EN::MEDMEM_HEXA8    )));
    _cell_models.insert(make_pair(MED_EN::MEDMEM_TETRA10  ,CELLMODEL(MED_EN::MEDMEM_TETRA10  )));
    _cell_models.insert(make_pair(MED_EN::MEDMEM_PYRA13   ,CELLMODEL(MED_EN::MEDMEM_PYRA13   )));
    _cell_models.insert(make_pair(MED_EN::MEDMEM_PENTA15  ,CELLMODEL(MED_EN::MEDMEM_PENTA15  )));
    _cell_models.insert(make_pair(MED_EN::MEDMEM_HEXA20   ,CELLMODEL(MED_EN::MEDMEM_HEXA20   )));
    _cell_models.insert(make_pair(MED_EN::MEDMEM_POLYGON  ,CELLMODEL(MED_EN::MEDMEM_POLYGON  )));
    _cell_models.insert(make_pair(MED_EN::MEDMEM_POLYHEDRA,CELLMODEL(MED_EN::MEDMEM_POLYHEDRA)));
  };
