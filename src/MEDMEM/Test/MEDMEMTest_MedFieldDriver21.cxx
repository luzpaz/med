...
void MEDMEMTest::testMedFieldDriver21()
{
  ...
  MED_FIELD_RDONLY_DRIVER21<int> *aInvalidMedRdFieldDriver21_1 = new MED_FIELD_RDONLY_DRIVER21<int>(fileNotExist_rd, aField);
  ...
  MED_FIELD_RDONLY_DRIVER21<int> *aInvalidMedRdFieldDriver21_2 = new MED_FIELD_RDONLY_DRIVER21<int>(emptyfilename, aField);
  ...
  /////////////////////////////////////////////////////
  MED_FIELD_RDONLY_DRIVER21<int> *aInvalidMedRdFieldDriver21_3 = new MED_FIELD_RDONLY_DRIVER21<int>(filenameWithOutFileds, aField);
  ...
  MED_FIELD_RDONLY_DRIVER21<int> *aMedRdFieldDriver21 = new MED_FIELD_RDONLY_DRIVER21<int>(filename_rd, aField);
  ...
  MED_FIELD_RDONLY_DRIVER21<int> aMedRdFieldDriver21Cpy_2 = MED_FIELD_RDONLY_DRIVER21<int> (*aMedRdFieldDriver21);
  ...
  MED_FIELD_WRONLY_DRIVER21<int> *aInvalidMedWrFieldDriver21_1 = new MED_FIELD_WRONLY_DRIVER21<int>(fileNotExist_wr, aField_1);
  //Trying open not existing file
  ...
  MED_FIELD_WRONLY_DRIVER21<int> *aInvalidMedWrFieldDriver21_2 = new MED_FIELD_WRONLY_DRIVER21<int>(emptyfilename, aField_1);
  ...
  //Creation Invalid Write Only MedFieldDriver21 
   MED_FIELD_WRONLY_DRIVER21<int> *aInvalidMedWrFieldDriver21_3 = new MED_FIELD_WRONLY_DRIVER21<int>(emptyfile_wr, aField);
  ...
  //////////////////////////////////////////////
  //Creation Invalid Write Only MedFieldDriver21 
  MED_FIELD_WRONLY_DRIVER21<int> *aInvalidMedWrFieldDriver21_4 = new MED_FIELD_WRONLY_DRIVER21<int>(other_file_wr, aField);
  ...
  MED_FIELD_WRONLY_DRIVER21<int> *aMedWrFieldDriver21 = new MED_FIELD_WRONLY_DRIVER21<int>(filename_wr, aField);
  ...
  //Test (bool operator ==) defined GENDRIVER class in MEDMEM_GenDriver.hxx
  CPPUNIT_ASSERT(aMedWrFieldDriver21Cpy_1 ==  *aMedWrFieldDriver21);
  
  //Test copy constructor
  MED_FIELD_WRONLY_DRIVER21<int> aMedWrFieldDriver21Cpy_2 = MED_FIELD_WRONLY_DRIVER21<int> (*aMedWrFieldDriver21);
  ...
  MED_FIELD_RDWR_DRIVER21<int> *aInvalidMedRdWrFieldDriver21_1 = new MED_FIELD_RDWR_DRIVER21<int>(fileNotExist_wr, aField_1);
  //Trying open not existing file
  ...
  MED_FIELD_RDWR_DRIVER21<int> *aInvalidMedRdWrFieldDriver21_2 = new MED_FIELD_RDWR_DRIVER21<int>(emptyfilename, aField_1);
  //Trying open not existing file and file with empty name
  ...
  //  TEST3: Reading field from file without fields  //
  /////////////////////////////////////////////////////
  MED_FIELD_RDWR_DRIVER21<int> *aInvalidMedRdWrFieldDriver21_3 = new MED_FIELD_RDWR_DRIVER21<int>(filenameWithOutFileds, aField_1);
  ...
  //Creation Invalid Read/Write MedFieldDriver21
   MED_FIELD_RDWR_DRIVER21<int> *aInvalidMedRdWrFieldDriver21_4 = new MED_FIELD_RDWR_DRIVER21<int>(emptyfile_rdwr, aField);
  ...
  //////////////////////////////////////////////
  //Creation Invalid Read/Write MedFieldDriver21 
  MED_FIELD_RDWR_DRIVER21<int> *aInvalidMedRdWrFieldDriver21_5 = new MED_FIELD_RDWR_DRIVER21<int>(other_file_wr, aField);
  ...
  MED_FIELD_RDWR_DRIVER21<double> *aMedRdWrFieldDriver21 = new MED_FIELD_RDWR_DRIVER21<double>(filename_rdwr, aField_2);
  ...
  //Test (bool operator ==) defined GENDRIVER class in MEDMEM_GenDriver.hxx
  CPPUNIT_ASSERT(aMedRdWrFieldDriver21Cpy_1 ==  *aMedRdWrFieldDriver21);
  
  //Test copy constructor
  MED_FIELD_RDWR_DRIVER21<double> aMedRdWrFieldDriver21Cpy_2 = MED_FIELD_RDWR_DRIVER21<double> (*aMedRdWrFieldDriver21);
