...
inline int GRID::getNumberOfElements(MED_EN::medEntityMesh entity, MED_EN::medGeometryElement Type) const
{
  int numberOfElements=0;
    ...
    if (entity==MED_EN::MED_FACE && (Type==MED_EN::MED_QUAD4 || Type==MED_EN::MED_ALL_ELEMENTS) && _meshDimension>2)
      numberOfElements=
    ...
    {
      numberOfElements=(_iArrayLength-1)*_jArrayLength + (_jArrayLength-1)*_iArrayLength;
      if (_kArrayLength )
        numberOfElements = numberOfElements * _kArrayLength +
