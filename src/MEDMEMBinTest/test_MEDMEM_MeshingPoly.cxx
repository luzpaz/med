...
int main (int argc, char ** argv) {
  ...
  const int REFpolyIndex[3] = {1, 47, 92 };
  ...
  medGeometryElement Types[NumberOfTypes] = {MEDMEM_TETRA4, MEDMEM_POLYHEDRA};
  const int NumberOfElements[NumberOfTypes] = {1,2};
  ...
  NumberOfNodes = 9;
  SpaceDimension = 3;
  medGeometryElement PolygonTypes[NumberOfTypes] = {MEDMEM_TRIA3,MEDMEM_POLYGON};
