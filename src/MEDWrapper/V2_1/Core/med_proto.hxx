...
namespace med_2_1{
/* Fichier */
MED_V21_WRAPPER_EXPORT extern med_idt
MEDouvrir(char *nom, med_mode_acces mode_acces);
MED_V21_WRAPPER_EXPORT extern med_err 
MEDfermer(med_idt fid); 
MED_V21_WRAPPER_EXPORT extern med_int
...
MED_V21_WRAPPER_EXPORT extern void
...
/* Resultat */
MED_V21_WRAPPER_EXPORT extern med_err MEDchampCr(med_idt fid, char *champ, med_type_champ type, char *comp,
...
MED_V21_WRAPPER_EXPORT med_int MEDnGrid(med_idt fid, char *maa, med_grid n);
MED_V21_WRAPPER_EXPORT med_err MEDgridCr(med_idt fid, char *maillage, med_int dim, med_grid_type typ);
MED_V21_WRAPPER_EXPORT med_err MEDgridInfo(med_idt fid, int indice, med_int *isAGrid, med_grid_type *typ);
MED_V21_WRAPPER_EXPORT med_err MEDgridEcr(
...
MED_V21_WRAPPER_EXPORT med_err MEDgridLire(
...
MED_V21_WRAPPER_EXPORT med_err MEDfamGridEcr(med_idt fid, char *maa, med_int *fam, med_int n, med_mode_acces mode, med_entite_maillage type_ent);
MED_V21_WRAPPER_EXPORT med_err MEDfamGridLire(med_idt fid, char *maa, med_int *fam, med_int n, med_entite_maillage type_ent);
MED_V21_WRAPPER_EXPORT med_err MEDbodyFittedEcr(
...
MED_V21_WRAPPER_EXPORT med_err MEDbodyFittedLire(
