...
#endif
med_err
MEDgaussInfo(med_idt fid, int indice, char * locname, med_geometry_type * type_geo,
             med_int * ngauss );
  ...
  namespace V2_2
  {
                  ...
                  TErr* theErr)
    {
      ...
      TErr aRet = MEDmeshInfo(myFile->Id(),
                              ...
                              &aSpaceDim,
                              &aDim,
                              &aType,&theInfo.myDesc[0],dtunit,&sorttype,&nstep,&at,axisname,axisunit);
      delete [] axisname;
      delete [] axisunit;
      if(aRet < 0)
                  ...
                  TErr* theErr)
    {
      ...
      TErr aRet = MEDmeshCr(myFile->Id(),
                            &aMeshName,
                            aSpaceDim,aDim,
                            aType,&aDesc,"",MED_SORT_DTIT,MED_CARTESIAN,nam,unit);
      delete [] nam;
      delete [] unit;
                    ...
                    TErr* theErr)
    {
      ...
      TErr aRet = MEDfamilyInfo(myFile->Id(),
                                &aMeshName,
                                theFamId,
                                &aFamilyName,
                                &aFamilyId,&aGroupNames);
      
      //&anAttrId,&anAttrVal,&anAttrDesc,&aNbAttr,&aGroupNames,&aNbGroup
                    ...
                    TErr* theErr)
    {
      ...
      TErr aRet = MEDfamilyCr(myFile->Id(),&aMeshName, &aFamilyName,
                              aFamilyId,aNbGroup,&aGroupNames);
               ...
               TErr* theErr)
    {
      ...
      TErr aRet = MEDmeshEntityNameRd(myFile->Id(),&aMeshName,MED_NO_DT,MED_NO_IT,anEntity,aGeom,&anElemNames);
                    ...
                    TErr* theErr)
    {
      ...
      TErr aRet = MEDmeshEntityNumberRd(myFile->Id(),&aMeshName,MED_NO_DT,MED_NO_IT,
                                        anEntity,aGeom,&anElemNum);
                  ...
                  TErr* theErr)
    {
      ...
      TErr aRet = MEDmeshEntityFamilyNumberRd(myFile->Id(),&aMeshName,MED_NO_DT,MED_NO_IT,anEntity,aGeom,&aFamNum);
               ...
               TErr* theErr)
    {
      ...
      if(theInfo.myIsElemNames){
        ...
        aRet  = MEDmeshEntityNameWr(myFile->Id(),&aMeshName,MED_NO_DT,MED_NO_IT,anEntity,
                                    aGeom, (TInt)anInfo.myElemNames->size(),&anElemNames);
        if(theErr) 
          *theErr = aRet;
        else if(aRet < 0)
                    ...
                    TErr* theErr)
    {
      ...
      if(theInfo.myIsElemNum){
        ...
        aRet  = MEDmeshEntityNumberWr(myFile->Id(),&aMeshName,
                                      MED_NO_DT,MED_NO_IT,anEntity,aGeom,
                                      (TInt)anInfo.myElemNum->size(),&anElemNum);
        if(theErr) 
          *theErr = aRet;
        else if(aRet < 0)
                  ...
                  TErr* theErr)
    {
      ...
      TErr aRet = MEDmeshEntityFamilyNumberWr(myFile->Id(),&aMeshName,MED_NO_DT,MED_NO_IT,anEntity,aGeom,
                                              (TInt)anInfo.myFamNum->size(),&aFamNum);
                 ...
                 TErr* theErr)
    {
      ...
      med_bool chgt,trsf;
      return MEDmeshnEntity(myFile->Id(),&aMeshName,MED_NO_DT,MED_NO_IT,MED_NODE,MED_NONE,MED_COORDINATE,MED_NO_CMODE,&chgt,&trsf);
    }
                  ...
                  TErr* theErr)
    {
      ...
      TErr aRet = MEDmeshNodeCoordinateRd(myFile->Id(),&aMeshName,MED_NO_DT,MED_NO_IT,aModeSwitch,&aCoord);
      MEDmeshEntityFamilyNumberRd(myFile->Id(),&aMeshName,MED_NO_DT,MED_NO_IT,MED_NODE,MED_NONE,&aFamNum);
      MEDmeshEntityNameRd(myFile->Id(),&aMeshName,MED_NO_DT,MED_NO_IT,MED_NODE,MED_NONE,&anElemNames);
      MEDmeshEntityNumberRd(myFile->Id(),&aMeshName,MED_NO_DT,MED_NO_IT,MED_NODE,MED_NONE,&anElemNum);
                  ...
                  TErr* theErr)
    {
      ...
      TErr aRet = MEDmeshNodeCoordinateWr(myFile->Id(),&aMeshName,MED_NO_DT,MED_NO_IT,MED_NO_DT,aModeSwitch,
                                          aNbElem,&aCoord);
      MEDmeshEntityFamilyNumberWr(myFile->Id(),&aMeshName,MED_NO_DT,MED_NO_IT,MED_NODE,MED_NONE,aNbElem,&aFamNum);
      if(anIsElemNames)
        MEDmeshEntityNameWr(myFile->Id(),&aMeshName,MED_NO_DT,MED_NO_IT,MED_NODE,MED_NONE,aNbElem,&anElemNames);
      if(anIsElemNum)
        MEDmeshEntityNumberWr(myFile->Id(),&aMeshName,MED_NO_DT,MED_NO_IT,MED_NODE,MED_NONE,aNbElem,&anElemNum);
      if(theErr) 
        *theErr = aRet;
      else if(aRet < 0)
                      ...
                      TErr* theErr)
    {
      ...
      TErr aRet;
      aRet = MEDmeshPolygonRd(myFile->Id(),&aMeshName,MED_NO_DT,MED_NO_IT,anEntity,aConnMode,&anIndex,&aConn);
                      ...
                      TErr* theErr)
    {
      ...
      TErr aRet = MEDmeshPolygonWr(myFile->Id(),&aMeshName,MED_NO_DT,MED_NO_IT,MED_NO_DT,anEntity,aConnMode,anInfo.myNbElem + 1,
                                   &anIndex,&aConn);
                          ...
                          TErr* theErr)
    {
      ...
      med_int aTaille = 0;
      med_bool chgt,trsf;
      aTaille=MEDmeshnEntity(myFile->Id(),&aMeshName,MED_NO_DT,MED_NO_IT,med_entity_type(theEntity),MED_POLYGON,MED_CONNECTIVITY,
                             med_connectivity_mode(theConnMode),&chgt,&trsf);
                      ...
                      TErr* theErr)
    {
      ...
      TErr aRet;
      aRet = MEDmeshPolyhedronRd(myFile->Id(),&aMeshName,MED_NO_DT,MED_NO_IT,MED_CELL,aConnMode,&anIndex,&aFaces,&aConn);
                      ...
                      TErr* theErr)
    {
      ...
      TErr aRet;
      aRet = MEDmeshPolyhedronWr(myFile->Id(),&aMeshName,MED_NO_DT,MED_NO_IT,MED_NO_DT,MED_CELL,aConnMode,
                                 anInfo.myNbElem+1,&anIndex,(TInt)anInfo.myFaces->size(),&aFaces,&aConn);
      ...
      if(theInfo.myIsElemNames){
        TValueHolder<TString, char> anElemNames(anInfo.myElemNames);
        aRet  = MEDmeshEntityNameWr(myFile->Id(),&aMeshName,MED_NO_DT,MED_NO_IT,anEntity,MED_POLYHEDRON,(TInt)anInfo.myElemNames->size(),
                                    &anElemNames);
        if(theErr) 
          *theErr = aRet;
        else if(aRet < 0)
      ...
      if(theInfo.myIsElemNum){
        TValueHolder<TElemNum, med_int> anElemNum(anInfo.myElemNum);
        aRet = MEDmeshEntityNumberWr(myFile->Id(),&aMeshName,MED_NO_DT,MED_NO_IT,anEntity,MED_POLYHEDRON,(TInt)anInfo.myElemNum->size(),
                                     &anElemNum);
        if(theErr) 
          *theErr = aRet;
        else if(aRet < 0)
      ...
      TValueHolder<TElemNum, med_int> aFamNum(anInfo.myFamNum);
      aRet = MEDmeshEntityFamilyNumberWr(myFile->Id(),&aMeshName,MED_NO_DT,MED_NO_IT,anEntity,MED_POLYHEDRON,(TInt)anInfo.myFamNum->size(),
                                         &aFamNum);
                          ...
                          TErr* theErr)
    {
      ...
      med_bool chgt,trsf;
      theNbFaces=MEDmeshnEntity(myFile->Id(),&aMeshName,MED_NO_DT,MED_NO_IT,MED_CELL,MED_POLYHEDRON,MED_INDEX_NODE,aConnMode,&chgt,&trsf);
      theConnSize=MEDmeshnEntity(myFile->Id(),&aMeshName,MED_NO_DT,MED_NO_IT,MED_CELL,MED_POLYHEDRON,MED_CONNECTIVITY,aConnMode,&chgt,&trsf);
                 ...
                 TErr* theErr)
    {
      ...
      return MEDmeshnEntity(myFile->Id(),&aMeshName,MED_NO_DT,MED_NO_IT,med_entity_type(theEntity),
                            med_geometry_type(theGeom),MED_CONNECTIVITY,med_connectivity_mode(theConnMode),&chgt,&trsf);
    }
                  ...
                  TErr* theErr)
    {
      ...
      TErr aRet;
      aRet=MEDmeshElementRd(myFile->Id(),&aMeshName,MED_NO_DT,MED_NO_IT,anEntity,aGeom,aConnMode,aModeSwitch,
                            &aConn,&anIsElemNames,&anElemNames,&anIsElemNum,&anElemNum,&anIsFamNum,&aFamNum);
      if(theErr) 
        *theErr = aRet;
      else if(aRet < 0)
                  ...
                  TErr* theErr)
    {
      ...
      TErr aRet;
      aRet = MEDmeshElementWr(myFile->Id(),&aMeshName,MED_NO_DT,MED_NO_IT,MED_NO_DT,anEntity,aGeom,aConnMode,aModeSwitch,anInfo.myNbElem,
                              &aConn,anIsElemNames,&anElemNames,anIsElemNum,&anElemNum,anIsFamNum,&aFamNum);
                   ...
                   TErr* theErr)
    {
      ...
      aRet=MEDfieldInfo(myFile->Id(),theFieldId,&aFieldName[0],&aMeshInfo.myName[0],&local,&aType,&aCompNames,&anUnitNames,dtunit,&nbofstp);
                   ...
                   TErr* theErr)
    {
      ...
      TErr aRet;
      char dtunit[MED_LNAME_SIZE+1];
      std::fill(dtunit,dtunit+MED_LNAME_SIZE+1,'\0');
      aRet = MEDfieldCr(myFile->Id(),&aFieldName,aType,anInfo.myNbComp,
                        &aCompNames,&anUnitNames,dtunit,&aMeshInfo.myName[0]);
      if(theErr) 
        *theErr = aRet;
      else if(aRet < 0)
                      ...
                      TErr* theErr)
    {
      ...
      aRet = MEDlocalizationInfo (myFile->Id(),
                                  ...
                                  &nsectionmeshcell,&sectiongeotype);
      if(theErr) 
        *theErr = aRet;
      else if(aRet < 0)
                   ...
                   TErr* theErr)
    {
      ...
      TErr aRet;
      aRet = MEDlocalizationRd(myFile->Id(),&aGaussName,aModeSwitch,
                               &aRefCoord,&aGaussCoord,&aWeight);
                     ...
                     TErr* theErr)
    {
      ...
      TErr aRet;
      aRet = MEDprofileRd(myFile->Id(),&aProfileName,
                          &anElemNum);
      if(theErr) 
        *theErr = aRet;
      else if(aRet < 0)
                      ...
                      TErr* theErr)
    {
      ...
      for(; anIter != localEntityInfo.end(); anIter++){
        ...
        for(; anGeomIter != aGeom2Size.end(); anGeomIter++){
          ...
          TInt aNbStamps;
          MEDfieldInfoByName(anId,&aFieldName,meshName,&islocal,&ft,cname,unitname,dtunit,&aNbStamps);
          delete [] cname;
          delete [] unitname;
          ...
          if(anIsSatisfied){
            ...
            if(anIsPerformAdditionalCheck){
              ...
              for(TInt iTimeStamp = 1; iTimeStamp <= iTimeStampEnd; iTimeStamp++){
                ...
                med_int aNumOrd;
                med_float aDt;
                TErr aRet=MEDfieldComputingStepInfo(anId,&aFieldName,iTimeStamp,&aNumDt,  
                                                    &aNumOrd,&aDt);
                       ...
                       TErr* theErr)
    {
      ...
      for(; anIter != aGeom2Size.end(); anIter++){
        ...
        TErr aRet;
        aRet=MEDfieldComputingStepInfo(myFile->Id(),&aFieldName,theTimeStampId,&aNumDt,  
                                       &aNumOrd,&aDt);
        char profilename[MED_NAME_SIZE+1];
        med_int profilsize;
        char locname[MED_NAME_SIZE+1];
        MEDfieldnValueWithProfile(myFile->Id(),&aFieldName,aNumDt,aNumOrd,anEntity,med_geometry_type(aGeom),
                                  1,MED_COMPACT_PFLMODE,profilename,&profilsize,locname,&aNbGauss);
                        ...
                        TErr* theErr)
    {
      ...
      for(; anIter != aGeom2Size.end(); anIter++){
        ...
        TInt aNbVal = MEDfieldnValueWithProfile(anId,
                                                ...
                                                1,aProfileMode,
                                                profilename,&profilesize,locname,&aNbGauss);
        if(aNbVal <= 0){
          if(theErr){
            *theErr = -1;
            return;
                        ...
                        TErr* theErr)
    {
      ...
      for(; anIter != aGeomSet.end(); anIter++){
        ...
        aRet = MEDfieldValueWithProfileWr(anId,&aFieldName,aNumDt,aNumOrd,aDt,anEntity,med_geometry_type(aGeom),
                                          aProfileMode,&aProfileName[0],&aGaussName[0],aModeSwitch,MED_ALL_CONSTITUENT,aNbVal,
                                          theTimeStampValue->GetValuePtr(aGeom));
        if(aRet < 0){
          if(theErr){
            *theErr = MED_FALSE;
                    ...
                    TErr* theErr)
    {
      ...
      if(anInfo.myGrilleType == eGRILLE_STANDARD){
        ...
        aRet=MEDmeshNodeCoordinateWr(myFile->Id(),&aMeshName,MED_NO_DT,MED_NO_IT,MED_NO_DT,aModeSwitch,aNbNoeuds,&aCoord);
        ...
        aRet = MEDmeshGridStructWr(myFile->Id(),
                                    &aMeshName,MED_NO_DT,MED_NO_IT,MED_NO_DT,
                                    &aGrilleStructure);
        if(aRet < 0)
        ...
        for(med_int aAxis = 0; aAxis < aMeshInfo.myDim; aAxis++){
          aRet=MEDmeshGridIndexCoordinateWr(myFile->Id(),&aMeshName,MED_NO_DT,MED_NO_IT,MED_NO_DT,aAxis+1,anInfo.GetIndexes(aAxis).size(),
                    ...
                    TErr* theErr)
    {
      ...
      if(aMaillageType == eSTRUCTURE && aGrilleType == eGRILLE_STANDARD){
        ...
        aRet=MEDmeshNodeCoordinateRd(myFile->Id(),&aMeshName,MED_NO_DT,MED_NO_IT,aModeSwitch,&aCoord);
        ...
        aRet = MEDmeshEntityFamilyNumberRd(myFile->Id(),
                                           &aMeshName,MED_NO_DT,MED_NO_IT,med_entity_type(eNOEUD),med_geometry_type(ePOINT1),
                                           &aFamNumNode);
                    ...
                    TErr* theErr)
    {
      ...
      if(aMeshInfo.myType == eSTRUCTURE){
        TValueHolder<TString, char> aMeshName(aMeshInfo.myName);
        TValueHolder<EGrilleType, med_axis_type> aGrilleType(theGrilleType);
        //aGrilleType=MED_CARTESIAN;
        //to do
